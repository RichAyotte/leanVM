            ...
            Line::Statement {
                ...
                match value {
                    ...
                    Expression::FunctionCall {
                        ...
                        // Special handling for poseidon8 precompile (7 variants).
                        if ALL_POSEIDON8_NAMES.contains(&function_name.as_str()) {
                            ...
                            let (permute, half_output, is_hardcoded_left) = match function_name.as_str() {
                                POSEIDON8_NAME => (false, false, false),
                                POSEIDON8_QUARTER_NAME => (false, true, false),
                                POSEIDON8_HARDCODED_LEFT_NAME => (false, false, true),
                                POSEIDON8_QUARTER_HARDCODED_LEFT_NAME => (false, true, true),
                                POSEIDON8_PERMUTE_NAME => (true, false, false),
                                POSEIDON8_PERMUTE_HALF_NAME => (true, true, false),
                                POSEIDON8_PERMUTE_HALF_HARDCODED_LEFT_NAME => (true, true, true),
                                _ => unreachable!(),
                            };
