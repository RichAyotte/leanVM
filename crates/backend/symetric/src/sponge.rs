...
/// LTR = Left-to-right. Absorbs starting from the provided `initial_state` in RATE-sized chunks.
#[inline(always)]
pub fn hash_iter_with_initial_state<T, Comp, I, const WIDTH: usize, const RATE: usize, const OUT: usize>(
    comp: &Comp,
    mut iter: I,
