...
The claimed value $c$ (input of the opening) belongs to the \emph{statement}: making it simulatable is the job of \Cref{sec:zk-logup-gkr,sec:zk-air-sumcheck,sec:zk-column-evals}.
